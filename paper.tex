...
coercions in normal forms and threesomes. But they are presented in
different dynamic semantics, which make it difficult to compare the
key differences between the cast representations. We present a
...
parameterized over Cast ADTs.  The Cast ADT brings another benefit:
...
representations
(\cite{Garcia:2013:CTB:2500365.2500603,siek2012interpretations}).  We
...
\todo[inline]{KC: I feel ``going through a bisimulation proof'' is too specific.
There should be other ways to prove equivalence of two dynamic semantics.
How does Jeremy think?}
\todo[inline]{JS: yes}
