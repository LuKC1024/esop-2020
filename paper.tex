...
\todo[inline]{JS: no, that's too deep into the details for the introduction
   of a paper that is not about variable representations.}
...
\todo[inline]{JS: While I see what you're saying, its important
  to give precendence to the definition that is earlier in time.}
