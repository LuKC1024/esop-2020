...
\todo[inline]{KC: I am citing \cite{siek2012interpretations} for Lazy D coercions
in normal form, is this the right paper to cite?}
...
We use monadic \texttt{let} in paper presentation but the monad bind operator
in Agda code. The monadic \texttt{let} is defined as follows:
\[
\begin{array}{rcll}
    (\mlet{x}{(\error{l})}{e}) & = & \error{l} \\
    (\mlet{x}{a}{e}) & = & e[a/x] & \text{otherwise} \\ 
\end{array}
\]
% We use 
...
\todo[inline]{KC: conditions of blame strategy. Jeremy, please }
