...
cast representations.  For illustration, we apply the framework to
...
Siek and Garcia~\citep{siek2012interpretations}.
...
strategies and because New et al.~\citep{new2019gradual} show that the eager
...
\todo[inline]{JS: Good question! I would like to use citet as well.}
