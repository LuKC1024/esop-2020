...
These cast representations shall be proved not changing the overall
behavior of language implementations except saving space.
Existing proofs typically go through a bisimulation between
a space-efficient semantics, which use a specific cast representation,
and the definitional but inefficient semantics \citep{Siek:2010:TWB:1706299.1706342,Siek:2015:BCT:2737924.2737968}.
% Problem
This technique imposes unnecessary burden in proving such theorems
because a considerable portion of the semantics is irrelevant to
casts.
% Solution
To isolate cast representations from the remaining part of 
semantics, we present a abstract data type, namely Cast ADT,
...
Our generic dynamic semantics comes with generic theorems,
...
extended continuations bisimulate. Both of them are straightforward to
proof.
