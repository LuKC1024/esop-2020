...
Existing proofs typically go through a bisimulation between
the language semantics and a space-efficient one 
...
We have successfully applied our new approach to the proofs of
correctness for two space-efficient cast representations from the
literature
...
representations
\citep{Garcia:2013:CTB:2500365.2500603,siek2012interpretations}.  We
also present a new cast representation, hypercoercions, that is more
friendly to mechanized meta-theory and consumes less memory than
