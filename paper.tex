...
\newcommand{\proxy}[2]{\ensuremath{\mathit{proxy}(#1,#2)}}
\newcommand{\applyCast}[2]{\ensuremath{\mathit{applyCast}(#1,#2)}}
\newcommand{\project}[4]{\ensuremath{\mathit{project}(#1,#2,#3,#4)}}
\newcommand{\composegap}[3]{\ensuremath{#1 \fatsemi #2 \fatsemi #3}}
\newcommand{\mkhead}[2]{\ensuremath{\mathit{mkProj}(#1,#2)}}
\newcommand{\mktail}[2]{\ensuremath{\mathit{mkInj}(#1,#2)}}
...
\newcommand{\castToDyn}[2]{\ensuremath{\mathit{castToDyn}(#1,#2)}}
\newcommand{\castFromDyn}[2]{\ensuremath{\mathit{castFromDyn}(#1,#2)}}
\newcommand{\dom}[1]{\ensuremath{\mathit{dom}(#1)}}
\newcommand{\cod}[1]{\ensuremath{\mathit{cod}(#1)}}
\newcommand{\car}[1]{\ensuremath{\mathit{car}(#1)}}
\newcommand{\cdr}[1]{\ensuremath{\mathit{cdr}(#1)}}
\newcommand{\id}[1]{\ensuremath{\mathit{id}(#1)}}
\newcommand{\idm}[1]{\ensuremath{\mathit{id}_m(#1)}}
\newcommand{\idc}[1]{\ensuremath{\mathit{id}_c(#1)}}
...
Jeremy G. Siek\inst{1} \and
Andre Kuhlenschmidt\inst{1}
}
%
...
%
\institute{Indiana University, Bloomington IN 47405, USA}
...
\todo[inline]{Cite "Contracts for higher-order functions" for the proxy-based approach?}
...
\todo[inline]{Actuallythink twosome's composition is structurally recursive but threesomes' is not}
...
\todo[inline]{how to make citet work?}
...
\caption{Syntax of a CEK machine \RMachine{B} and auxiliary definitions.}
...
\begin{figure}
	...
	\figreduceto{\sexpr{\ecar{e}}{E}{K}}{\sexpr{e}{E}{\Kcons{\Fcar}{K}}}{}
	\figreduceto{\sexpr{\ecdr{e}}{E}{K}}{\sexpr{e}{E}{\Kcons{\Fcdr}{K}}}{}
	\figreducetoH{
	...
	\figreduceto{\scont{\vcons{v_1}{v_2}}{\Kcons{\Fcar}{K}}}{\scont{v_1}{K}}{}
	\figreducetoH{\scont{\vconsc{u}{S_1}{T_1}{l}{S_2}{T_2}}{\Kcons{\Fcar}{K}}}{
		\scont{u}{
			\Kcons{\Fcar}{
				\Kcons{\Fcast{\ccast{S_1}{l}{S_2}}}{K}}}	
	}{}
	\figreduceto{\scont{\vcons{v_1}{v_2}}{\Kcons{\Fcdr}{K}}}{\scont{v_2}{K}}{}
	\figreducetoH{\scont{\vconsc{u}{S_1}{T_1}{l}{S_2}{T_2}}{\Kcons{\Fcdr}{K}}}{
		\scont{u}{
			\Kcons{\Fcdr}{
				\Kcons{\Fcast{\ccast{T_1}{l}{T_2}}}{K}}}	
	}{}
	...
	\caption{Dynamic semantics of the cast calculi as a CEK
		machine \RMachine{B}. The transitions that involve casts are highlighted
		in red.}
	\label{fig:R-machine-dynamics}
\end{figure}

The transition relation \reduceto{s}{s} invokes the cast application function, 
noted as $\applyCast{v}{\ccast{S}{l}{T}}$ to allow for the differences 
between blame strategies (Fig.~\ref{fig:blame-strategy-LazyD} and 
Fig.~\ref{fig:blame-strategy-LazyUD}).
%
When evaluating a cast expression, the machine moves the cast to the
continuation and evaluates the inner expression.
%
To cast a value, the machine invokes the cast application function on the 
value. The cast result is either a value or an error (\error{l}). If the cast 
succeeds, the machine returns the value to the next continuation.  If the cast 
fails, the machine halts with the blame label.
%
...
%
To take out the first part of a casted pair, the machine takes out the 
first part of the inner pair $u$ and cast it.
%
Taking out the second part is similar.

The reflexive transitive closure of reduction (\transitivelyreduceto{s}{s}) 
and evaluation (${\evalto{e}{o}}$) are standard~\citep{felleisen03:_pllc}.
...
We conjecture that \LDMachine\ agrees with the \LD\ cast calculus
of \citep{siek2009exploring}.
...
respect to \LD\ are in the injectable types and in the definition of the 
${\mathit{applyCast}(v,\ccast{S}{l}{T})}$
function, in which a cast whose source or target is the dynamic type
\Tdyn\ is always split into two casts that go through a ground type, that is, a 
type in which all sub-components are the dynamic type, such as 
\Pfunc{\Tdyn}{\Tdyn}.
...
\begin{figure}
	...
	\figreduceto{\sexpr{\ecar{e}}{E}{K}}{
		\sexpr{e}{E}{\mkCont{\Kcons{\Fcar}{K}}}
	}{}
	\figreduceto{\sexpr{\ecdr{e}}{E}{K}}{
		\sexpr{e}{E}{\mkCont{\Kcons{\Fcdr}{K}}}
	}{}
	\figreducetoH{
		\sexpr{\ecast{e}{\ccast{S}{l}{T}}}{E}{K}
	}{
...
%		\casttyping{K}{\Pprod{T_1}{T_2}}{T'}
	...
	\\
	\figequaltoH{
		\applyCont{\ecast{\vcons{v_1}{v_2}}{\Pprod{c_1}{c_2}}}{\Kcons{\Fcar}{K}}
	}{
		\denote{c_1}(v_1) \mbind \lambda u.
		\scont{u}{K}
	}{}
	\figequaltoH{
		\applyCont{\ecast{\vcons{v_1}{v_2}}{\Pprod{c_1}{c_2}}}{\Kcons{\Fcdr}{K}}
	}{
...
\begin{lemma}[Lazy D $\mathit{applyCast}$ Preserves Bisimulation]
...
\begin{lemma}[Lazy UD $\mathit{applyCast}$ Preserves Bisimulation]
...
\begin{theorem}[Correctness of Lazy D \SMachine{C}]
	...
	\[
	\machineequiv{\RBMachine}{\SMachine{C}}
	\]
\end{theorem}
\begin{proof}
	By the definitions of $\textit{eval}$, we need to show 
	\[
	\transitivelyreducetoM{\RMachine{B}}{\sexpr{e}{\emptyset}{\Knil}}{
		s
	}
	\;\text{if and only if}\;
...
\figequalto{
	...
	\hcmprod{
		(\composegap{c_1}{\car{g}}{c_2})}{
		(\composegap{d_1}{\cdr{g}}{d_2})}
}{}
\end{array}
\]	
...
\[
\begin{array}{rclr}
\figequalto{\car{\gnone}}{\gnone}{}
\figequalto{\car{\gsome{\Pprod{S_1}{T_1}}{l}{\Pprod{S_2}{T_2}}}}{
	\gsome{S_1}{l}{S_2}
}{}
\end{array}
\]
...
\[
\begin{array}{rclr}
\figequalto{\cdr{\gnone}}{\gnone}{}
\figequalto{\cdr{\gsome{\Pprod{S_1}{T_1}}{l}{\Pprod{S_2}{T_2}}}}{
	\gsome{T_1}{l}{T_2}
}{}
\end{array}
\]
...
\todo[inline]{KC: Should we mention KC and Deyaa as citation?
...
a parameterized abstract machine \effCEK{C}, 
