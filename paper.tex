...
\todo[inline]{JS: there is a least one interesting difference regarding
  the bisimulation: your lemma 3 has an ``upto reduction'' flavor to it
  which makes your $\approx$ relation simpler. }
\todo[inline]{KC: updated.}
