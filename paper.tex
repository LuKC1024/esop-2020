...
\todo[inline]{JS: First? What about \url{https://arxiv.org/abs/2001.11560}?}
\todo[inline]{KC: My bad. I don't remember how this word gets in but I
definitely should be more careful about these kind of words. BTW, should
the arxiv paper go into Related Work?}
...
cast representations.
\todo[inline]{JS: Say the framework is in Agda.}
\todo[inline]{KC: Has said, at the end of this paragraph}
...
representations.  The framework and illustrations (written in Agda)
...
section makes it easier to prove these machines are equivalent.  Of
course, one should also prove that the abstract machine presented here
is equivalent to the standard reduction semantics for cast calculi,
but we have not yet done so.

\todo[inline]{JS: We might cite the proof of correctness for CEK in the
  PLT Redex book and conjecture that it would be straightforward to
  adapt.}
...
${\mathit{applyCast}(v,\ccast{S}{l}{T})}$, in which a cast whose source or
target is the dynamic type \Tdyn\ is always split into two casts that
go through a ground type, that is, a 
