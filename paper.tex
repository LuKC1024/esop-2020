...
cast calculi parameterized over cast representations, similar to
our \CMachine{B}. The two corresponding interfaces, namely
$\mathrm{CastStruct}$ and $\mathrm{EfficientCastStruct}$, give
users more control over the structure of values. \CMachine{B} machine
...
\todo[inline]{KC: [IMPORTANT] will do.}
...
of \translate{\ccast{S}{l}{T}}. Readers are encouraged to compare these two
definitions with the corresponding $\mathrm{applyCast}$ functions 
